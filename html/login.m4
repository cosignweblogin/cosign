...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<td height="487" class="maincell">
		...
		<tr>
		    <td align="right" valign="middle" class="topbar"> <img src="/cosign/images/yellow_divdots.gif" width="12" height="20" align="absmiddle" class="leftbuffer"><a href="#" class="graylink"> Forgotten Password? </a> <img src="/cosign/images/yellow_divdots.gif" width="12" height="20" align="absmiddle" class="leftbuffer"><a href="#" class="graylink">Request an Account</a> <img src="/cosign/images/yellow_divdots.gif" width="12" height="20" align="absmiddle" class="leftbuffer"><a href="#" class="graylink">Help</a>
		    </td>
		</tr>
		<tr>
			...
			<table width="200" height="230"  border="0" align="right" cellpadding="0" cellspacing="0" class="logobox">
				...
				<td>
					...
					<tr>
					    <td>&nbsp;</td>
					    <td><img src="/cosign/images/username_graphic.gif" width="53" height="15"></td>
					    <td>&nbsp;</td>
					</tr>
					<tr>
					    <td rowspan="4" valign="middle"><img src="/cosign/images/bracket_left.gif" width="12" height="60" hspace="4"></td>
					    <td><input type="text" id="login" name="login" size="15" value="$l"></td>
					    <td rowspan="4" valign="middle"><img src="/cosign/images/bracket_right.gif" width="12" height="60" hspace="4"></td>
					</tr>
					<tr>
					    <td><img src="/cosign/images/spacer.gif" width="1" height="8"></td>
					</tr>
					<tr>
					    <td><img src="/cosign/images/password_text.gif" width="53" height="15"></td>
					</tr>
					<tr>
		...
		<tr>
		    <td class="message-area"><img src="/cosign/images/icon_sysmessage.gif" width="14" height="14"> <strong>$t:</strong> $e </td>
		</tr>
		<tr>
